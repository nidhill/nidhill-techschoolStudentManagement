      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-gray-800 rounded-lg shadow-2xl p-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                placeholder="Enter SHO username"
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                placeholder="Enter SHO password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200"
            >
              {loading ? 'Signing in...' : 'Login as SHO'}
            </button>

            <div className="text-center">
              <a href="#" className="text-white hover:text-purple-300 text-sm">
                Forgot Password?
              </a>
            </div>
          </form>
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="flex-1 bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-lg text-sm font-medium transition duration-200"
              >
                Admin
              </button>
              <button
          ...
          <div className="mt-6 bg-purple-900/20 border border-purple-500/30 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-purple-300 mb-2">Test Accounts:</h3>
