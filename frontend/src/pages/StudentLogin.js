        ...
        <div className="bg-gray-800 rounded-lg shadow-2xl p-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200"
            >
              {loading ? 'Signing in...' : 'Login as Student'}
            </button>

            <div className="text-center">
              <a href="#" className="text-white hover:text-green-300 text-sm">
                Forgot Password?
              </a>
            </div>
          </form>
          ...
          <div className="mt-6 bg-green-900/20 border border-green-500/30 p-4 rounded-lg">
            <h3 className="text-sm font-medium text-green-300 mb-2">Test Accounts:</h3>
